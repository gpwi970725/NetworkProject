...
void * send_msg(void * arg) {   // send thread main
	...
	while(1) 
	{
		...
		if(!strcmp(msg,"/exit\n")) {
			...
			write(sock, &fSize, sizeof(int)); // ÆÄÀÏ Å©±âÁ¤º¸ ¸ÕÀú º¸³¿.
			fSize = 0;
			...
			while(1) {
				...
				if(Flength != BUF_SIZE) {
					...
					//¤¤ fread ´Â ÆÄÀÏ³¡¿¡ ´ê¾ÒÀ» ¶§ ÀÌÀüÀÇ µ¥ÀÌÅÍ¿Í ÇÔÃÄÁüÀÌ ÀÖÀ» ¼ö ÀÖÀ¸¹Ç·Î ¹æÁöÇÏ¿´À½.
		...
		} // ¤¤ ÆÄÀÏ ¼ö½Å½Ã ÆÄÀÏ ÀÌ¸§À» ¼³Á¤ÇÏ´Â °æ¿ì
			...
			// ¤¤ ¾Æ¹«°Íµµ ÀÔ·Â¹ÞÁö ¾Ê¾ÒÀ»¶§´Â Ãâ·ÂÇÏÁö ¾ÊÀ½
			// ¤¤ ¸Þ½ÃÁö º¸³»±â
